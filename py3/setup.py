...
# ./pypiUploadVer DID NOT exist -- forPypiVersion=0.82 -- forSysVersion=0.8 -- constant=NA
def pkgVersion():
        return '0.8'
...
'bin/dsnMsgPlugin.py',
'bin/marmee-admin.cs',
'bin/marmee-assemble.cs',
'bin/marmee-binsPrep.cs',
